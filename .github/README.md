...
[`@aws-sdk/client-quicksight`](https://www.npmjs.com/package/@aws-sdk/client-quicksight/v/3.839.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-quicksight@3.839.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CEY8bI5pi6WrcxI0+uY6dAsvtfkAvlSXuthOo5vEfOHeuZEOTzeV05mzH86Korcu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-quicksight": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-quicksight@3.839.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-quicksight@3.839.0/index.min.mjs": "sha384-CEY8bI5pi6WrcxI0+uY6dAsvtfkAvlSXuthOo5vEfOHeuZEOTzeV05mzH86Korcu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-quicksight/blob/refs/tags/3.839.0/LICENSE
```
